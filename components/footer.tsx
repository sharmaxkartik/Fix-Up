    ...
    <footer className="border-t">
      <div className="container flex flex-col gap-8 py-8 md:flex-row md:py-12">
        <div className="flex-1 space-y-4">
          <h2 className="font-bold">FixUp</h2>
          <p className="text-sm text-muted-foreground">Fixing the future starts now—FixUp is here to innovate the way we repair and reuse!</p>
        </div>
      ...
      <div className="container border-t py-6">
        <p className="text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} FixUp, Inc. All rights reserved.
        </p>
      </div>
    </footer>
  )
